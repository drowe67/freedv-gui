...
if [ ! -d Python.framework ]; then
    ...
    ./make_relocatable_python_framework.py --python-version 3.14.3 --os-version=11 --destination $PWD/../
    cd ..
