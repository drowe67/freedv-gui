...
void OmniRigController::setFrequencyMode(uint64_t frequency, Mode mode)
{
    enqueue_(std::bind(&OmniRigController::setFrequencyModeImpl_, this, frequency, mode));
}
...
void OmniRigController::setFrequencyModeImpl_(uint64_t frequencyHz, IRigFrequencyController::Mode mode)
{
    bool changed = false;
