...
TopFrame::TopFrame(wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style) : wxFrame(parent, id, title, pos, size, style)
{
    ...
    m_rb2020a = new wxRadioButton( modeBox, wxID_ANY, wxT("2020A"), wxDefaultPosition, wxDefaultSize,  0);
    sbSizer_mode->Add(m_rb2020a, 0, wxALIGN_LEFT|wxALL, 1);
    sbSizer_mode->SetMinSize(wxSize(100,-1));
    ...
    m_rb2020->MoveBeforeInTabOrder(m_rb2020a);
    m_rb2020a->MoveBeforeInTabOrder(m_rb2020b);
    ...
    m_rb2020a->Connect(wxEVT_RADIOBUTTON, wxCommandEventHandler(TopFrame::OnChangeTxMode), NULL, this);
...
TopFrame::~TopFrame()
{
    ...
    m_rb2020a->Disconnect(wxEVT_RADIOBUTTON, wxCommandEventHandler(TopFrame::OnChangeTxMode), NULL, this);
