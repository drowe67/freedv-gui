            ...
            )
{
    ...
    uint32_t inSampleSize = length_input_short;
    uint32_t outSampleSize = length_output_short;
    speex_resampler_process_int(src, 0, input_short, &inSampleSize, output_short, &outSampleSize);
