...
void MainFrame::startRxStream()
{
    ...
    if(!m_RxRunning) {
        ...
        int soundCard1InFifoSizeSamples = 60 * wxGetApp().appConfiguration.audioConfiguration.soundCard1In.sampleRate;
        ...
        if (g_nSoundCards == 2)
        {
            int soundCard2InFifoSizeSamples = 60*wxGetApp().appConfiguration.audioConfiguration.soundCard2In.sampleRate;
