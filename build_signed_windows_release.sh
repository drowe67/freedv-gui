...
wget https://www.python.org/ftp/python/3.14.1/python-3.14.1-amd64.exe
Xvfb :99 -screen 0 1024x768x16 &
DISPLAY=:99.0 wine ./python-3.14.1-amd64.exe /quiet /log c:\\python.log InstallAllUsers=1 Include_doc=0 Include_tcltk=0
